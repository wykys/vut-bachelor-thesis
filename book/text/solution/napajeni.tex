...
Úbytky napětí na modré a zelené LED (3,4~\jedn{V}) v součtu s úbytky vznikající na spínacích prvcích při regulování jasu převyšují hodnotu napětí aktumulátoru, bylo tedy nutné navrhnout napájecí systém založený na zvyšujícím měniči napětí.
