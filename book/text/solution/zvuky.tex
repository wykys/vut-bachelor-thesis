...
Pro generátor je jedním z nejdůležitějších požadavků jeho paměť alespoň 1~\jedn{MB} možnost jej řídit pomocí \zkratka{UART} a jednoduchá indikace přehrávání a možnost snížit odběr generátoru pomocí GPIO.
