...
\end{figure}
Hlavním funkcí zbraně je vysílání IR signálu. Ten je generován MCU STM32F042F6P, který je založený na ARM jádru Cortex M0. Je vybaven 32~\jedn{kB} FLASH a 6~\jedn{kB} SRAM. Generovaný IR signál je složen ze dvou signálů a to nosného a datového. tyto dva signály jsou směšovány dohromady pomocí hradla AND a následně je jím ovládána vysílací IR LED.
