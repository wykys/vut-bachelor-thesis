...
\paragraph{Vesta}
má na hrudi upevněnou hlavní \zkratka{DPS}. Ta obsahuje řídící mikrokontrolér, komunikační \zk{WiFi} modul, jeden \zkratka{IR} detektor obklopen čtveřicí \zkratka{RGB} \zkratka{LED} pro identifikaci týmu, znakový displej a konektory pro připojení zbraně a dalších \zkratka{DPS}. Na zádech vesty je upevněn modul obsahující nabíječku, \zkratka{IR} detektor a čtyři \zkratka{RGB} \zkratka{LED}. Na zádech vesty je také upevněn akumulátor, který napájí celou vestu i zbraň. Dále má vesta dvě totožné \zkratka{DPS} na ramenou, každá obsahuje tři \zkratka{IR} detektory a dvě \zkratka{RGB} \zkratka{LED}.
